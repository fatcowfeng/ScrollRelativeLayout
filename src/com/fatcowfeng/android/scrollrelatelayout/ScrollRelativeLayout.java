...
import com.fatcowfeng.android.R;
...
public class ScrollRelativeLayout extends RelativeLayout {
    ...
    public ScrollRelativeLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ScrollRelativeLayout);
        topOffset = a.getDimensionPixelSize(R.styleable.ScrollRelativeLayout_limitheight, 0);
        a.recycle();
    }
